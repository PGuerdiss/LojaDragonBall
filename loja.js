...
function addProductToCart(event) {
  ...
  const productPrice = productInfos.getElementsByClassName("valorP")[0].innerText
  ...
  newCartProduct.innerHTML =
    `
      ...
      <td>
        <span class="valorCarrinho">${productPrice}</span>
      </td>
      <td>
...
function updateTotal() {
  ...
  for (var i = 0; i < cartProducts.length; i++) {
    const productPrice = cartProducts[i].getElementsByClassName("valorCarrinho")[0].innerText.replace("R$", "").replace(",", ".")
